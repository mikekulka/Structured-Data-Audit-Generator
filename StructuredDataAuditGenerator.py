...
#print(parse_sitemap('https://www.monmouth.edu/sitemap_index.xml', ['loc']))
parse_sitemap('https://www.monmouth.edu/sitemap_index.xml', ['loc']).to_csv(r'pandas.txt', header=None, index=None, sep=' ', mode='a')
urlArr = parse_sitemap('https://www.monmouth.edu/sitemap_index.xml', ['loc'])['loc'].to_numpy()


with open('nextSite.txt', 'w') as f:
    for u in urlArr:
        f.write(u)
        f.write('\n')
